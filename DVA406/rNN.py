...
class NN:
    ...
    def test(self, patterns):
        ...
        for p in patterns:
            ...
            write_file_object.writerow(upVal)
            print(p[0], '->', upVal)
    ...
    def train(self, patterns, iterations=100, N=0.3, M=0.5):
        # N: learning rate
        # M: momentum factor
        wfileNew = open('D:/rNNerrorsNew.csv','wb')
        wfile = open('D:/rNNerrors.csv','wb')
        for i in range(iterations):
            ...
            for p in patterns:
                ...
                self.update(inputs)
                lowest = 1.0
                newError = self.backPropagate(targets, N, M)
...
if __name__ == '__main__':
    ...
    run()
    #pycallgraph.make_dot_graph('D:/IntelligentSystems/kaggle/rNNCallGraph.png')
    #print strftime("%a, %d %b %Y %H:%M:%S +0000", gmtime())