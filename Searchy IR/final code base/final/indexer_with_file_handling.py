...
#intitalizes list
for item in index :
    outlist.setdefault(item,[]).append(index[item])



outfile = open("C:/python27/indexer.txt","a",0)
infile = open("C:/python27/indexer.txt","wb",0)


lines_seen = {}

for line1 in open("C:/python27/indexer.txt") :
    key, value = line1.split()
    lines_seen[key] = value
...
for line in sorted(outlist) :
    if line not in lines_seen :
        print >>outfile,line,":",outlist[line]
        outfile.write('\n')
